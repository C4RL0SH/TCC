 ...
 * @author Carlos
 */
public class FuncionarioE extends javax.swing.JInternalFrame {
    ...
    private void salvarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_salvarMouseClicked
       ...
       funcionario.setId_funcionario((int)jTable1.getValueAt(jTable1.getSelectedRow(), 0));
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
      if (jTable1.getSelectedRow() != -1) {
        ...
        data.setDateFormatString(jTable1.getValueAt(jTable1.getSelectedRow(),9).toString());
        sexo.setSelectedItem(jTable1.getValueAt(jTable1.getSelectedRow(),10).toString());    
        turno.setSelectedItem(jTable1.getValueAt(jTable1.getSelectedRow(),11).toString());
        cargo.setSelectedItem(jTable1.getValueAt(jTable1.getSelectedRow(),12).toString());
